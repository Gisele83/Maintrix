  ...
  const navigation = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: "Équipements", href: "/gmao", icon: Cpu },
        { name: "Ordres de Travail", href: "/gmao", icon: Wrench },
        { name: "Maintenance Préventive", href: "/gmao", icon: Settings },
        { name: "Stock & Pièces", href: "/gmao", icon: Database },
      ]
    },
    {
      name: "IoT & Monitoring",
